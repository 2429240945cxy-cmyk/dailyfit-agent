...
def search_usda_sr_cache(query: str, fallback_reason: str | None = "cached_reference") -> NutritionResult | None:
    q = _norm(query)
    best = None
    ...
    return NutritionResult(
        ...
        fallback_used=True,
        fallback_from=["usda_fdc_live", "openfoodfacts"],
        fallback_to="usda_sr_legacy_cache",
